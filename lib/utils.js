...
//     return window.opera ? "Opera": /chrom/i.test(ua) ? "Chrome": /msie/i.test(ua) ? "Internet Explorer": /AppleWebKit/.test(navigator.appVersion) ? "Safari": /mozilla/i.test(ua) && !/compatible|webkit/i.test(ua) ? "Firefox": ""
// }
